...
namespace VoxelEngine.Audio
{
    ...
    {
        //private const string nativeLibName = "wrap_oal.dll";// "OpenAL32.dll";// soft_oal.dll";
        private const string nativeLibName = "OpenAL32.dll";// soft_oal.dll";
        ...
        public static extern void alutInit(int[] argc, char[] argv);
